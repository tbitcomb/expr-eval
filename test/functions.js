...
describe('Functions', async function () {
  ...
  describe('map(f, a)', async function () {
    ...
    it('should fail if first argument is not a function', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('map(4, [])'); }, /not a function/);
    });

    it('should fail if second argument is not an array', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('map(random, 0)'); }, /not an array/);
    });
  ...
  describe('fold(f, init, array)', async function () {
    ...
    it('should fail if first argument is not a function', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('fold(4, 0, [])'); }, /not a function/);
    });

    it('should fail if third argument is not an array', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('fold(random, 0, 5)'); }, /not an array/);
    });
  ...
  describe('filter(f, array)', async function () {
    ...
    it('should fail if first argument is not a function', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('filter(4, [])'); }, /not a function/);
    });

    it('should fail if second argument is not an array', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('filter(random, 5)'); }, /not an array/);
    });
  ...
  describe('indexOf(target, array)', async function () {
    ...
    it('should fail if second argument is not an array or string', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('indexOf(5, 5)'); }, /not a string or array/);
    });
  ...
  describe('join(sep, array)', async function () {
    it('should fail if second argument is not an array', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('join("x", "y")'); }, /not an array/);
    });
  ...
  describe('sum(array)', async function () {
    it('should fail if the argument is not an array', async function () {
      var parser = new Parser();
      assert.rejects(async function () { await parser.evaluate('sum(1)'); }, /not an array/);
    });
